...
const SignUp = () => {
  ...
  return (
    <div
      className="flex items-center justify-center min-h-screen bg-gradient-to-br from-[#1d0f27] to-[#2c3364] relative overflow-hidden"
    >
    <div className='bg-white h-[500px] max-w-md w-1/2 rounded-l-lg overflow-hidden'>
      ...
      <div className="bg-white p-8 rounded-r-lg h-[500px]  shadow-md w-1/2 max-w-md relative z-10">
        <h2 className="text-3xl font-semibold text-blue-600 mb-6 text-center">Create Your Account</h2>
        ...
        {message && <p className={`mt-4 text-center ${message == "Account created successfully!"? "text-green-400" : "text-red-400"}`}>{message}</p>}
